            ...
            <div class="col-lg-12">
                <form class="p-4 p-md-5 border rounded" action="job-update.php?id=<?php echo $id;?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $single_job->job_title; ?>" required type="text" name="job_title" class="form-control" id="job-title" placeholder="Product Designer">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $single_job->vacancy; ?>" required name="vacancy" type="text" class="form-control" id="job-location" placeholder="e.g. 3">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input  required name="application_deadline" type="text" class="form-control" id="" placeholder="e.g. 20-12-2022" value="<?php echo $single_job->application_deadline; ?>">
                    </div>

                    <div class="row form-group">
                        <div class="col-md-12">
                            <label class="text-black" for="">Job Description</label>
                            <textarea required name="job_description" id="" cols="30" rows="7" class="form-control" placeholder="Write Job Description..."><?php echo $single_job->job_description; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <textarea required name="responsibilities" id="" cols="30" rows="7" class="form-control" placeholder="Write Responsibilities..."><?php echo $single_job->responsibilities; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <textarea required name="education_experience" id="" cols="30" rows="7" class="form-control" placeholder="Write Education & Experience..."><?php echo $single_job->education_experience; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <textarea required name="other_benifits" id="" cols="30" rows="7" class="form-control" placeholder="Write Other Benifits..."><?php echo $single_job->other_benifits ?></textarea>
                        </div>
                    </div>
